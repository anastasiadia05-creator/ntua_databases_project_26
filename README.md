...
- 🧑‍⚕️ **Προσωπικό** — ιατροί (με ιεραρχία εποπτείας), νοσηλευτές, διοικητικό προσωπικό
...
> ⚠️ Τα scripts έχουν γραφτεί και δοκιμαστεί σε **PostgreSQL 15+**. Δεν χρησιμοποιούνται enums, arrays, JSON ή XML.
